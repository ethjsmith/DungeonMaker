...
allshapes = pyglet.graphics.Batch()
# no image
def line(x,y,xx,yy):
    l = shapes.Line(x,y,xx,yy,width=4,batch=allshapes)


@window.event
def on_draw():
    window.clear()
    batch.draw() # is this some animation stuff ?
...
#pyglet testing... yet another file lmfao :_)
